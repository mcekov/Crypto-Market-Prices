          ...
          <div className="flex justify-between">
            {coin.market_data?.current_price ? (
              <p className="text-3xl font-bold">
                &euro;{coin.market_data.current_price.eur.toLocaleString()}
              </p>
            ) : null}
            <p>7 Day</p>
          </div>
          ...
          <div className="flex justify-between py-4">
            <div>
              ...
              {coin.market_data?.market_cap ? (
                <p>&euro;{coin.market_data.market_cap.eur.toLocaleString()}</p>
              ) : null}
            </div>
            <div>
              ...
              {coin.market_data?.market_cap ? (
                <p>
                  &euro;{coin.market_data.total_volume.eur.toLocaleString()}
                </p>
              ) : null}
            </div>
          </div>
          ...
          <div className="flex justify-between py-4">
            <div>
              ...
              {coin.market_data?.high_24h ? (
                <p>&euro;{coin.market_data.high_24h.eur.toLocaleString()}</p>
              ) : null}
            </div>
            <div>
              <p className="text-gray-500 text-sm">24h Low</p>
              {coin.market_data?.low_24h ? (
                <p>&euro;{coin.market_data.low_24h.eur.toLocaleString()}</p>
              ) : null}
            </div>
          </div>
        </div>
